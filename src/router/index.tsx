  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/vessel/berth" element={<ProtectedRoute><GenericPage title="泊位计划" /></ProtectedRoute>} />
        
        <Route path="/container/gate-in" element={<ProtectedRoute><GenericPage title="集装箱进闸" /></ProtectedRoute>} />
        ...
        <Route path="/driver/appointment" element={<ProtectedRoute><GenericPage title="提箱预约" /></ProtectedRoute>} />
        ...
        <Route path="/claim/apply" element={<ProtectedRoute><GenericPage title="理赔申请" /></ProtectedRoute>} />
        <Route path="/claim/approve" element={<ProtectedRoute><GenericPage title="理赔审批" /></ProtectedRoute>} />
